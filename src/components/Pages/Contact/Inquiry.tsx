          ...
          <ul className="list-unstyled contact-details__list">
            <li>
              ...
              <div className="contact-details__content">
                <h4>
                  <a href="tel:9200368090" className="contact-details__number-1">+92 (003) 68-090</a>
                  <a href="tel:6668888000" className="contact-details__number-2">+ 666 8888 000</a>
                </h4>
              </div>
            </li>
            <li>
              ...
              <div className="contact-details__content">
                <h4>
                  <a href="mailto:info@company.com" className="contact-details__number-1">info@company.com</a>
                  <a href="mailto:needhelp@company.com"
                    className="contact-details__number-2">needhelp@company.com</a>
                </h4>
              </div>
            </li>
            <li>
