                        ...
                        <div className="col-lg-8 col-md-12">
                            <div className="blog-details-desc">
                                ...
                                <div className="article-content">
                                    <h3>Advance Diploma in Fire And Industrial Safety Engineering<br /></h3><h6>(CHRED Govt. Of India)</h6>
                                    <p>You can join <b>join Correspondence Diploma Courses in Advance Diploma in Fire
...
export default RegularCourseDetailTwo