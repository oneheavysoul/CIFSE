                        ...
                        <div className="col-lg-8 col-md-12">
                            <div className="blog-details-desc">
                                <div className="article-image">
                                    <img src={publicUrl + "assets/images/regular-course/2.jpg"} alt="image" />

                                </div>
                                <div className="article-content">
                                    <h3>Diploma in Disaster Management<br /></h3><h6>(CHRED Govt. Of India)</h6>
                                    <p>You can join <b>Correspondence Diploma Courses</b> in <b>Diploma in Disaster
                                        Management, </b> Exam will be held on July or Dec every year, you can pursue
                                        3 year diploma, just you have to send Demand Draft infavour of
                                        <b>CENTRAL INSTITUTE OF FIRE AND SAFETY ENGINEERING</b> Payable at
                                        <b>GANGHINAGAR</b> of amount <b>Rs 10,000</b> course fee. As soon as we received your
                                        <b>Demand Draft</b> and <b>Application Form</b> we will send you <b>Study Material</b> at your
                                        given address.
                                    </p>
                                    <p>Management courses that we offer are highly compatible with <b>MSBTE
                            ...
                            <aside className="widget-area">
                                <div className="widget widget_grin_posts_thumb">
                                    ...
                                    <article className="item">
                                        ...
                                        <div className="info">
                                            <h4 className="title usmall">
                                                <a href="blog-details.html">Advance Diploma in Industrial Safety Engineering</a>
                                            </h4>
                                        </div>
                                    </article>
                                    <article className="item">
