                        ...
                        <div className="col-lg-8 col-md-12">
                            <div className="blog-details-desc">
                                ...
                                <div className="article-content">
                                    <h3>Diploma in Industrial Safety Management<br /></h3><h6>(CHRED Govt. Of India)</h6>
                                    <p>You can join <b>Correspondence Diploma Courses</b> in <b>Diploma in Industrial
