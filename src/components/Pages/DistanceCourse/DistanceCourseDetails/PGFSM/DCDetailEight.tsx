                        ...
                        <div className="col-lg-8 col-md-12">
                            <div className="blog-details-desc">
                                <div className="article-image">
                                    <img src={publicUrl + "assets/images/regular-course/5.jpg"} alt="image" />

                                </div>
                                <div className="article-content">
                                    <h3>PG Diploma in Fire and Safety Management<br /></h3><h6>(CHRED Govt. Of India)</h6>
                                    <p>You can join <b>Correspondence PG Diploma</b> in <b>Fire and Safety Management.</b>
                                        ...
                                        <table className="table">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>1 Year</td>
                                                    <td><b>Rs. 9500</b><br />(including study material and exam fees)</td>
                                                </tr>
                                                <tr>
                                                    <th scope="row">2</th>
