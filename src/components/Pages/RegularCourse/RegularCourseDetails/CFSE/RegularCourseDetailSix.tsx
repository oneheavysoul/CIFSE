                        ...
                        <div className="col-lg-8 col-md-12">
                            <div className="blog-details-desc">
                                <div className="article-image">
                                    <img src={publicUrl + "assets/images/regular-course/3.jpg"} alt="image" />

                                </div>
                                <div className="article-content">
                                    <h3>CFSE - Certificate in Fire and Safety Engineering</h3>
                                    <p>Join <b>Regular Diploma Courses</b> in <b>Certificate in Fire and Safety Engineering,</b>
                                        Exam will be held on July or Dec every year, you can pursue
                                        6 months diploma, Come to the campus for a guided tour & counselling and then
                                        apply <b>Gandhinagar,</b> Contact us on mobile (9am to 9pm) <b>0777799414</b> or
                                        Send us an email – <b>cifsevrl101@gmail.com</b>
                                    </p>
                                    <p>Engineering courses that we offer are highly compatible with <b>Government
                                    ...
                                    <div className='col-lg-12'>
                                        <table className="table">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <th scope="row">2</th>
                                                    <td>Fire Fighting Technology</td>
                                                    <td> </td>
                                                    <td></td>
                                                    <td></td>
                                                </tr>
                                                <tr>
                                                    <th scope="row">3</th>
                                                    <td>Fire Ground Communication</td>
                                                    <td> </td>
                                                    <td></td>
                                                    <td></td>
                                                </tr>
