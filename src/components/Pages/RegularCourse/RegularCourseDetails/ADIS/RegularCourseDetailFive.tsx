                        ...
                        <div className="col-lg-8 col-md-12">
                            <div className="blog-details-desc">
                                ...
                                <div className="article-content">
                                    <h3>MSBTE - Advance Diploma in Industrial Safety & Security Management</h3>
                                    <p>Join <b>Regular Diploma Courses</b> in <b>MSBTE - Advance Diploma in Industrial
                                        Safety & Security Management, </b> Exam will be held on July or Dec every year, you can pursue
                                        ...
                                        <table className="table">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>Any Graduate or Equivalent or Any Diploma</td>
